...
<div style="width: 1430px; height: 100%;">
    ...
    <table height="100%" width="1425" border="0" cellpadding="0" cellspacing="0" style="overflow: hidden;">
                ...
                <div>
                    <div id="header">
                        <div class="header01">
                            ...
                            <p class="right_02">
                                您好，<span><%=employee.getEmp_name()%></span>，欢迎登录！</p>
                        </div>
                    </div>
                </div>
            </td>
        ...
        <tr>
            <td width="190" valign="top" style="background: url(/images/lift_bj_02.gif) repeat-y;">
                <div class="side" style="position: absolute;">
                    <ul id="nav">
                        ...
                        <li class="y_css" id="xx8">
                            <a href="/ticket/BackTicket" target="mainFrame"><span></span>
                                <p class="icon_10">
                                    管理员退票
                                </p>
                            </a>
            ...
            <td width="1215" valign="top">
                <div id="dTitle" style="float:left; margin-left:25px;">
                </div>
