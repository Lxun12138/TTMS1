...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public List<Schedule> selectSchedule(String name) {
        ...
        if("".equals(name) || name == null){
            ...
            int id = playDAO.selectPlayByPlay_name(name).getPlay_id();
            System.out.println(id);
            list = scheduleDAO.selectScheduleByPlay_id(id);
        }
        return list;
    }
            ...
            if(play == null){
                ...
                try {
                    System.out.println(sched_time);
                        time = format.parse(sched_time.replace("T"," ")).getTime();
                    System.out.println("22222222222222"+time);
    ...
    public Studio searchbyscid(Schedule sche) {
        ...
        return scheduleDAO.searchbyscid(sche);
    }

    @Override
    public Play searchforplay(Schedule sche) {
        return scheduleDAO.searchforplay(sche);
    }
