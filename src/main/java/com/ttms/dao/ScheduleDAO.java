...
public interface ScheduleDAO {
    ...
    public Integer searchSchIdByInfo(@Param(value = "studio_id") int studio_id,
                                     @Param(value = "play_id") int play_id,
                                     @Param(value = "sched_time") String sched_time,
                                     @Param(value = "sched_ticket_price") Double sched_ticket_price);
