...
<%
    List<Play> lists = (List<Play>) request.getAttribute("plays");
%>
<body>
<div class="container">
        ...
        <div class="header_top">
            ...
            <div class="col-sm-6 nav">
                <ul class="ulul">
                    ...
                    <a href="#tt"><li>订单</li></a>
                </ul>
            </div>
            <div class="col-sm-3 header_right">
            <img src="/images/14.png" id="picc">
            <a href="/views/userregister.jsp" id="zhuce">注册</a>
            <a href="/views/userlogin.jsp" id="denglu">登录</a>
            </div>
        ...
        <div class="slider">
            <div class="callbacks_container">
                <ul class="rslides" id="slider">
                    <li><img src="/images/jlbhd.jpg" class="img-responsive" alt=""/>
                    </li>
                ...
                <div class="col-md-9 movie_box">
                    ...
                    <div class="movie movie-test movie-test-dark movie-test-left">
                        ...
                        <div class="movie__info">
                            <span class="movie__title"><%=list.getPlay_name()%> </span>
