...
<div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    ...
    <form action="/user/login" method="post"  id="formid" name="myform">
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="text" class="form-control" id="username" placeholder="用户名" name="username" regex="^\w{3,16}$" onchange="checkuser();"/>
        ...
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="password" class="form-control" id="password" placeholder="密 码" name="password" regex="^\w{6,16}$" onchange="checkuser();"/>
...
<div class="lc-block" id="l-forget-password" data-ng-class="{ 'toggled': lctrl.forgot === 1 }" data-ng-if="lctrl.forgot === 1">
    ...
    <form action="" method="post">
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="text" class="form-control" id="username1" placeholder="用户名" name="username" regex="^\w{3,16}$" onchange="checkuser();"/>
                <strong><span id="nameerror1" style="color:red; "></span></strong>
        ...
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input type="text" class="form-control" id="email1" placeholder="邮箱" regex="^\w+@\w+\.[a-zA-Z]+(\.[a-zA-Z]+)?$"  onchange="checkemail();"/>
